...
# Inputs
f_ratio = st.number_input("Front Sprocket Teeth", value=12)
r_ratio = st.number_input("Rear Sprocket Teeth", value=75)
rpm = st.number_input("Engine RPM", value=3600)
tire_size = st.number_input("Tire Diameter (Inches)", value=12) # Standard mini bike tire
